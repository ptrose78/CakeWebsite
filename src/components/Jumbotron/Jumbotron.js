  ...
  return (
    <div className="relative mt-6 w-full h-[575px] bg-pink-200 flex flex-col items-center justify-center text-center p-6 pt-4">
      <div className="mt-4">
        ...
        <p className="mt-2 text-xl text-brown-600 leading-relaxed italic">
          {subtext}
        </p>
        <div className="mt-10 w-half justify-center space-x-2 sm:space-x-6 md:space-x-8 md:hidden">
      ...
      <div className="relative mt-2 w-full h-[575px] bg-pink-200 flex flex-col items-center justify-center text-center p-6 pt-2">
